...
![1.png](image/backup_1.png)

![2.png](image/backup_2.png)
...
![6.png](image/backup_6.png)

API 응답 시간이 약 9초로 너무 길게 소요됩니다.

10,000건의 채팅메세지를 저장하고 기존에 있던 10,000건의 메세지를 삭제하기 때문에 소요시간이 길 수 밖에 없습니다.

조금 긴 응답 시간이 불가피해 보여 비동기로 처리하는 쪽이 좋을 거라고 생각이 되는데, 그래도 최대한 절대적인 시간을 줄이는 것 또한 필요해 보입니다.
...
단 건 insert: (10,000 _ N + \*\*10,000 _ M\*\*)

Batch insert: (10,000 _ N + \*\*10 _ M\*\*)
...
![12.png](image/backup_12.png)

### 최종 지연 시간

![13.png](image/backup_13.png)
